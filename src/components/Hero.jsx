...
export default function Hero() {
  return (
    <section className="h-screen flex items-center justify-between overflow-hidden md:mt-16">
      <div className="max-w-7xl px-4 sm:px-6 lg:px-8 text-center lg:text-left">
        <div className="max-w-3xl">
          ...
          <div className="flex items-center text-xs mx-auto md:mx-0 w-fit bg-slate-200 text-brand-navy-dark py-3 px-6 rounded-full">
